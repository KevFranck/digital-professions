      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="flex flex-col items-center md:items-start mb-4 md:mb-0">
            <div className="text-xl font-bold mb-2">Digital Professions</div>
            <p className="text-sm opacity-80">Explore careers in the digital world</p>
          </div>
          
          <div className="flex space-x-6">
            <a href="https://github.com/KevFranck" className="hover:text-primary transition-colors">
        ...
        <div className="border-t border-base-300 mt-6 pt-6 text-center md:text-left">
          <p className="text-sm opacity-75">
            &copy; {currentYear} <span className="font-semibold">Kevin</span>. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
